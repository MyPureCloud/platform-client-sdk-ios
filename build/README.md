...
Documentation version PureCloudPlatformClientV2@164.1.0
...
```
pod 'PureCloudPlatformClientV2', :git => 'https://github.com/MyPureCloud/platform-client-sdk-ios.git', :tag => '164.1.0'
```
