...
public class ShiftTradeQueryWeekSummariesBuJobResponse: Codable {
    ...
    public var queryWeekSummariesResult: QueryWeekSummaryListJobResponseItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, queryWeekSummariesResult: QueryWeekSummaryListJobResponseItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.queryWeekSummariesResult = queryWeekSummariesResult
