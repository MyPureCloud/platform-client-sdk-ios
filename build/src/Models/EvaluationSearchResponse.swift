...
public class EvaluationSearchResponse: Codable {
    ...
    public var results: [EvaluationSearchItemResponse]?
    /** Aggregation results */
    public var aggregations: [String:EvaluationSearchAggregationResponse]?

    public init(pageSize: Int?, pageNumber: Int?, results: [EvaluationSearchItemResponse]?, aggregations: [String:EvaluationSearchAggregationResponse]?) {
