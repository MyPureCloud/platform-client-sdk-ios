...
public class BotAggregationQuery: Codable {
    ...
    public enum GroupBy: String, Codable { 
        ...
        case botflowsubtype = "botFlowSubType"
        ...
        case botslotmechanism = "botSlotMechanism"
    ...
    public var sortMetric: BotAggregationSort?
    /** How many results you want in an ordered list. Only applicable for topN/bottomN query type. */
    public var limit: Int?

    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: BotAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [BotAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, queryType: QueryType?, sortMetric: BotAggregationSort?, limit: Int?) {
