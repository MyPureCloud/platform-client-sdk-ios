...
public class RelationshipsExport: Codable {
    ...
    public var queryConditions: RelationshipsExportQueryConditions?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, divisionIds: [String]?, createdBy: DomainEntityRef?, dateCreated: Date?, dateCompletion: Date?, status: Status?, downloadUrl: String?, resultRowCount: Int?, queryConditions: RelationshipsExportQueryConditions?, selfUri: String?) {
        self._id = _id
