...
public class FlowAsyncAggregationQuery: Codable {
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: FlowAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [FlowAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, pageSize: Int?) {
