...
public class ConversationEmailEventTopicEmailConversation: Codable {
    ...
    public var divisions: [ConversationEmailEventTopicConversationDivisionMembership]?

    public init(_id: String?, name: String?, participants: [ConversationEmailEventTopicEmailMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [ConversationEmailEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
