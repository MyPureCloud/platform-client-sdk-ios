...
public class CaseManagementAggregationQuery: Codable {
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: CaseManagementAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [CaseManagementAggregationView]?, alternateTimeDimension: AlternateTimeDimension?) {
