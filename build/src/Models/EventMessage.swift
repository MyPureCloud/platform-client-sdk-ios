...
public class EventMessage: Codable {
    ...
    public enum Code: String, Codable { 
        ...
        case anotherCampaignStarting = "ANOTHER_CAMPAIGN_STARTING"
        ...
        case campaignWhatsappHeaderValueLimitExceeded = "CAMPAIGN_WHATSAPP_HEADER_VALUE_LIMIT_EXCEEDED"
        case campaignWhatsappButtonUrlValueLimitExceeded = "CAMPAIGN_WHATSAPP_BUTTON_URL_VALUE_LIMIT_EXCEEDED"
        ...
        case campaignWeightZero = "CAMPAIGN_WEIGHT_ZERO"
        ...
        case importInvalidRetentionType = "IMPORT_INVALID_RETENTION_TYPE"
        case importInvalidRetentionDaysMustBeSet = "IMPORT_INVALID_RETENTION_DAYS_MUST_BE_SET"
        case importInvalidRetentionDaysMustNotBeSet = "IMPORT_INVALID_RETENTION_DAYS_MUST_NOT_BE_SET"
        case importInvalidRetentionDaysMustBePositive = "IMPORT_INVALID_RETENTION_DAYS_MUST_BE_POSITIVE"
        case importInvalidRetentionDaysExceedsLimit = "IMPORT_INVALID_RETENTION_DAYS_EXCEEDS_LIMIT"
        case importInvalidRetentionExpirationDateMustBeSet = "IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_BE_SET"
        case importInvalidRetentionExpirationDateMustNotBeSet = "IMPORT_INVALID_RETENTION_EXPIRATION_DATE_MUST_NOT_BE_SET"
        case importInvalidRetentionExpirationDateInvalidFormat = "IMPORT_INVALID_RETENTION_EXPIRATION_DATE_INVALID_FORMAT"
        case importInvalidRetentionExpirationDateNoSeconds = "IMPORT_INVALID_RETENTION_EXPIRATION_DATE_NO_SECONDS"
        case importInvalidRetentionExpirationDateExceedsLimit = "IMPORT_INVALID_RETENTION_EXPIRATION_DATE_EXCEEDS_LIMIT"
        case importInvalidRetentionMissingType = "IMPORT_INVALID_RETENTION_MISSING_TYPE"
        case importInvalidRetentionMissingPreferredTimezone = "IMPORT_INVALID_RETENTION_MISSING_PREFERRED_TIMEZONE"
        case importInvalidRetentionExpirationInPast = "IMPORT_INVALID_RETENTION_EXPIRATION_IN_PAST"
        case importContactListNameLengthExceeded = "IMPORT_CONTACT_LIST_NAME_LENGTH_EXCEEDED"
        case failedToDeleteContactList = "FAILED_TO_DELETE_CONTACT_LIST"
        case resourceNotFound = "RESOURCE_NOT_FOUND"
        case invalidContactUpdate = "INVALID_CONTACT_UPDATE"
        case organizationHasNoDomainSet = "ORGANIZATION_HAS_NO_DOMAIN_SET"
        case queueNotFound = "QUEUE_NOT_FOUND"
        ...
        case smsContentTemplateNotFound = "SMS_CONTENT_TEMPLATE_NOT_FOUND"
