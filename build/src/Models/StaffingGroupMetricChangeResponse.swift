...
public class StaffingGroupMetricChangeResponse: Codable {
    ...
    public init(numberOfWeeks: Int?, weekStartNumber: Int?, value: Double?, metric: Metric?, notes: String?, transfersFullTimeEquivalent: TransfersFullTimeEquivalent?, staffingGroups: [StaffingGroupReference]?, createdBy: UserReference?, createdDate: Date?) {
