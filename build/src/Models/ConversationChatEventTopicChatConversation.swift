...
public class ConversationChatEventTopicChatConversation: Codable {
    ...
    public var divisions: [ConversationChatEventTopicConversationDivisionMembership]?

    public init(_id: String?, name: String?, participants: [ConversationChatEventTopicChatMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [ConversationChatEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
