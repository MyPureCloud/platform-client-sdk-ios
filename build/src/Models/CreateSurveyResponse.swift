...
public class CreateSurveyResponse: Codable {
    ...
    public var customerSurveyUrl: String?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, name: String?, conversation: ConversationReference?, surveyForm: SurveyForm?, agent: DomainEntityRef?, status: Status?, queue: QueueReference?, answers: SurveyScoringSet?, completedDate: Date?, surveyErrorDetails: SurveyErrorDetails?, agentTeam: Team?, surveyType: SurveyType?, missingRequiredAnswer: Bool?, flow: AddressableEntityRef?, customerSurveyUrl: String?, selfUri: String?) {
        self._id = _id
        self.name = name
        ...
        self.flow = flow
        self.customerSurveyUrl = customerSurveyUrl
