...
public class ShiftTradeMatchTradeJobResponse: Codable {
    ...
    /** Results for MatchTrade job type */
    public var matchTradeResult: EvaluatedShiftTradeResponseItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, matchTradeResult: EvaluatedShiftTradeResponseItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.matchTradeResult = matchTradeResult
