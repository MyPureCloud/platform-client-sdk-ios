...
public class DecisionTableContract: Codable {
    ...
    public var parentSchema: BusinessRulesParentSchemaRef?
    ...
    public init(parentSchema: BusinessRulesParentSchemaRef?, rowAuthoringSchema: JsonSchemaDocument?, executionInputSchema: JsonSchemaDocument?, executionOutputSchema: JsonSchemaDocument?) {
