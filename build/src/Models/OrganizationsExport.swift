...
public class OrganizationsExport: Codable {
    ...
    public var queryConditions: OrganizationsExportQueryConditions?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, divisionIds: [String]?, createdBy: DomainEntityRef?, dateCreated: Date?, dateCompletion: Date?, status: Status?, downloadUrl: String?, resultRowCount: Int?, queryConditions: OrganizationsExportQueryConditions?, selfUri: String?) {
        self._id = _id
