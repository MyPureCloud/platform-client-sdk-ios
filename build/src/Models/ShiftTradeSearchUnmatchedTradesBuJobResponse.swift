...
public class ShiftTradeSearchUnmatchedTradesBuJobResponse: Codable {
    ...
    public var searchUnmatchedTradesResult: SearchUnmatchedShiftTradeListJobResponseItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, searchUnmatchedTradesResult: SearchUnmatchedShiftTradeListJobResponseItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.searchUnmatchedTradesResult = searchUnmatchedTradesResult
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case downloadUrl
        case error
        case searchUnmatchedTradesResult
        case selfUri
    }
