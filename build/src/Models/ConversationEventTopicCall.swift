...
public class ConversationEventTopicCall: Codable {
    ...
    public var recordersState: ConversationEventTopicRecordersState?
    ...
    public var disposition: ConversationEventTopicDisposition?
