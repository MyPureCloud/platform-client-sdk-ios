...
public class ShiftTradeAddTradeJobResponse: Codable {
    ...
    public var addTradeResult: ShiftTradeResponseItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, addTradeResult: ShiftTradeResponseItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.addTradeResult = addTradeResult
