...
public class FlowMetricsTopicFlowMetricRecord: Codable {
    ...
    public enum FlowSubType: String, Codable { 
        case virtualAgent = "VIRTUAL_AGENT"
    }
    ...
    public var flowSubType: FlowSubType?
