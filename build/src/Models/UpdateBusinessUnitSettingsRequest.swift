...
public class UpdateBusinessUnitSettingsRequest: Codable {
    ...
    public init(startDayOfWeek: StartDayOfWeek?, timeZone: String?, shortTermForecasting: BuShortTermForecastingSettings?, scheduling: BuSchedulingSettingsRequest?, notifications: BuNotificationSettingsRequest?, learning: BuActivitySettingsRequest?, coaching: BuActivitySettingsRequest?, metadata: WfmVersionedEntityMetadata?) {
