...
public class UpdateBusinessUnitSettingsRequest: Codable {
    ...
    public init(startDayOfWeek: StartDayOfWeek?, timeZone: String?, shortTermForecasting: BuShortTermForecastingSettings?, scheduling: BuSchedulingSettingsRequest?, notifications: BuNotificationSettingsRequest?, metadata: WfmVersionedEntityMetadata?) {
