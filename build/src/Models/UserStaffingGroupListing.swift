...
public class UserStaffingGroupListing: Codable {





    public var entities: [UserStaffingGroupResponse]?
    ...
    public init(entities: [UserStaffingGroupResponse]?, downloadUrl: String?) {
