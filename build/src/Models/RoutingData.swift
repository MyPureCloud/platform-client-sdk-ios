...
public class RoutingData: Codable {
    ...
    public init(queueId: String?, languageId: String?, label: String?, priority: Int?, skillIds: [String]?, skillExpression: String?, preferredAgentIds: [String]?, scoredAgents: [ScoredAgent]?, routingFlags: [String]?) {
