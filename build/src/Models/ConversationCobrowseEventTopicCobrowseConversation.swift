...
public class ConversationCobrowseEventTopicCobrowseConversation: Codable {
    ...
    public init(_id: String?, name: String?, participants: [ConversationCobrowseEventTopicCobrowseMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [ConversationCobrowseEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
