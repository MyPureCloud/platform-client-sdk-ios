...
public class KnowledgeAsyncAggregationQuery: Codable {
    ...
    public enum GroupBy: String, Codable { 
        ...
        case answergenerationenabled = "answerGenerationEnabled"
        ...
        case hasretrievedreferences = "hasRetrievedReferences"
    ...
    public var sortMetric: KnowledgeAggregationSort?
    /** How many results you want in an ordered list. Only applicable for topN/bottomN query type. */
    public var limit: Int?
    /** The number of results per page */
    public var pageSize: Int?

    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: KnowledgeAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [KnowledgeAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, queryType: QueryType?, sortMetric: KnowledgeAggregationSort?, limit: Int?, pageSize: Int?) {
