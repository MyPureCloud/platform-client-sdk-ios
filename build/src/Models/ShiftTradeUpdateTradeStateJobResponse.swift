...
public class ShiftTradeUpdateTradeStateJobResponse: Codable {
    ...
    public var updateTradeStateResult: BulkUpdateShiftTradeStateResultItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, updateTradeStateResult: BulkUpdateShiftTradeStateResultItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.updateTradeStateResult = updateTradeStateResult
