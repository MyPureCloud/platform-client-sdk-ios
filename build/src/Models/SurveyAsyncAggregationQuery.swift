...
public class SurveyAsyncAggregationQuery: Codable {
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: SurveyAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [SurveyAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, pageSize: Int?) {
