...
public class QueueConversationChatEventTopicChatConversation: Codable {
    ...
    public var divisions: [QueueConversationChatEventTopicConversationDivisionMembership]?

    public init(_id: String?, name: String?, participants: [QueueConversationChatEventTopicChatMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [QueueConversationChatEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
