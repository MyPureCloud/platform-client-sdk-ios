...
public class QueueConversationScreenShareEventTopicScreenShareConversation: Codable {
    ...
    public init(_id: String?, name: String?, participants: [QueueConversationScreenShareEventTopicScreenShareMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [QueueConversationScreenShareEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
