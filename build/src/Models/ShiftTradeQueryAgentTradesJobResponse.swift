...
public class ShiftTradeQueryAgentTradesJobResponse: Codable {
    ...
    public var queryAgentTradesResult: ShiftTradeListJobResponse?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, queryAgentTradesResult: ShiftTradeListJobResponse?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.queryAgentTradesResult = queryAgentTradesResult
