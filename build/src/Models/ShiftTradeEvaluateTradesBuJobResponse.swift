...
public class ShiftTradeEvaluateTradesBuJobResponse: Codable {
    ...
    /** Results for EvaluateTrades job type */
    public var evaluateTradesResult: EvaluateShiftTradeListJobResponseItem?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, evaluateTradesResult: EvaluateShiftTradeListJobResponseItem?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.evaluateTradesResult = evaluateTradesResult
