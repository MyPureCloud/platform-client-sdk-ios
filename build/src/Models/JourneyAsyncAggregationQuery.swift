...
public class JourneyAsyncAggregationQuery: Codable {
    ...
    public enum GroupBy: String, Codable { 
        ...
        case journeysegmentassignmentstate = "journeySegmentAssignmentState"
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: JourneyAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [JourneyAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, pageSize: Int?) {
