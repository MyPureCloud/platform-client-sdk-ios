...
public class JourneyExternalEventsSchema: Codable {
    ...
    public var jsonSchema: JourneyJsonSchemaDocument?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, version: Int?, enabled: Bool?, dateCreated: Date?, createdBy: DomainEntityRef?, jsonSchema: JourneyJsonSchemaDocument?, selfUri: String?) {
        self._id = _id
