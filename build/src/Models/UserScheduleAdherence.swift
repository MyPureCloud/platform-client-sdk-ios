...
public class UserScheduleAdherence: Codable {
    ...
    public var nextActivityReminders: [UserNextActivityReminder]?
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case nextActivityReminders
        case suppressOnTimeReminder
        case selfUri
    }
