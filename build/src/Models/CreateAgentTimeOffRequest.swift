...
public class CreateAgentTimeOffRequest: Codable {
    ...
    public init(activityCodeId: String?, notes: String?, fullDayManagementUnitDates: [String]?, fullDayEarliestStartOffsetMinutes: [Int]?, fullDayLatestEndOffsetMinutes: [Int]?, partialDayStartDateTimes: [Date]?, dailyDurationMinutes: Int?, durationMinutes: [Int]?, payableMinutes: [Int]?) {
