...
public class ConversationAsyncAggregationQuery: Codable {
    ...
    public enum Metrics: String, Codable { 
        ...
        case ocallbackservicelevel = "oCallbackServiceLevel"
    ...
    public var sortMetric: ConversationAggregationSort?
    /** How many results you want in an ordered list. Only applicable for topN/bottomN query type. */
    public var limit: Int?
    /** The number of results per page */
    public var pageSize: Int?

    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: ConversationAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [ConversationAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, queryType: QueryType?, sortMetric: ConversationAggregationSort?, limit: Int?, pageSize: Int?) {
