...
public class EvaluationAsyncAggregationQuery: Codable {
    ...
    public enum GroupBy: String, Codable { 
        ...
        case systemsubmitted = "systemSubmitted"
        case teamid = "teamId"
        case userid = "userId"
    }
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: EvaluationAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [EvaluationAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, pageSize: Int?) {
