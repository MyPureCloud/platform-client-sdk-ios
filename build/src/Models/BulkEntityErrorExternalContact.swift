...
public class BulkEntityErrorExternalContact: Codable {
    ...
    public init(code: String?, message: String?, status: Int?, retryable: Bool?, details: [BulkErrorDetail]?, entity: ExternalContact?) {
        self.code = code
