...
public class ShiftTradeBulkUpdateTradeStateBuJobResponse: Codable {
    ...
    /** Results for BulkUpdateTradeStates job type */
    public var bulkUpdateTradeStatesResult: BulkUpdateShiftTradeStateResult?
    /** The URI for this object */
    public var selfUri: String?

    public init(_id: String?, status: Status?, type: ModelType?, downloadUrl: String?, error: ErrorBody?, bulkUpdateTradeStatesResult: BulkUpdateShiftTradeStateResult?, selfUri: String?) {
        self._id = _id
        self.status = status
        self.type = type
        self.downloadUrl = downloadUrl
        self.error = error
        self.bulkUpdateTradeStatesResult = bulkUpdateTradeStatesResult
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case downloadUrl
        case error
        case bulkUpdateTradeStatesResult
        case selfUri
    }
