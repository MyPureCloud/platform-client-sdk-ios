...
public class ExternalOrganizationEnrichRequest: Codable {
    ...
    public init(_id: String?, division: WritableStarrableDivision?, matchingIdentifiers: [ExternalOrganizationIdentifier]?, action: Action?, externalOrganization: ExternalOrganization?, fieldRules: EnrichFieldRules?) {
        self._id = _id
