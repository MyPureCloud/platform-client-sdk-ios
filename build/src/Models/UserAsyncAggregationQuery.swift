...
public class UserAsyncAggregationQuery: Codable {
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: UserAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [UserAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, pageSize: Int?) {
