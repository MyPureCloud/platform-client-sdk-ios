...
public class ConversationMessageEventTopicMessageConversation: Codable {
    ...
    public var divisions: [ConversationMessageEventTopicConversationDivisionMembership]?

    public init(_id: String?, name: String?, participants: [ConversationMessageEventTopicMessageMediaParticipant]?, otherMediaUris: [String]?, address: String?, utilizationLabelId: String?, accessAttributes: [String]?, inactivityTimeout: Date?, divisions: [ConversationMessageEventTopicConversationDivisionMembership]?) {
        self._id = _id
        self.name = name
