...
public class InboundDomainPatchRequest: Codable {
    ...
    public init(mailFromSettings: MailFromResult?, customSMTPServer: DomainEntityRef?, imapSettings: ImapSettings?, graphApiSettings: GraphApiSettings?, emailSetting: EmailSettingReference?) {
