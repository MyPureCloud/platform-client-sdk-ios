...
public class TranscriptAsyncAggregationQuery: Codable {
    ...
    public init(interval: String?, granularity: String?, timeZone: String?, groupBy: [GroupBy]?, filter: TranscriptAggregateQueryFilter?, metrics: [Metrics]?, flattenMultivaluedDimensions: Bool?, views: [TranscriptAggregationView]?, alternateTimeDimension: AlternateTimeDimension?, queryType: QueryType?, sortMetric: TranscriptAggregationSort?, limit: Int?, pageSize: Int?) {
