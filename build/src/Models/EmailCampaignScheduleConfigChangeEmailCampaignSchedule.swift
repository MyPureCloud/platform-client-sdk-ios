...
public class EmailCampaignScheduleConfigChangeEmailCampaignSchedule: Codable {
    ...
    public var recurrences: [EmailCampaignScheduleConfigChangeScheduleRecurrence]?
    /** time zone identifier to be applied to the intervals; for example Africa/Abidjan */
    public var timeZone: String?
    public var emailCampaign: EmailCampaignScheduleConfigChangeUriReference?
