...
open class RecordingAPI {
  ...
  "recording" : {
    "originalRecordingStartTime" : "2000-01-23T04:56:07.000+00:00",
    "maxAllowedRestorationsForOrg" : 1,
  ...
  "region" : "af-south-1"
    ...
    /**
     ...
     - parameter emailFormatId: (query) The desired media format when downloading an email recording. Valid values:EML,NONE (optional)
     - parameter chatFormatId: (query) The desired media format when downloading a chat recording. Valid values:ZIP,NONE  (optional)
     - parameter messageFormatId: (query) The desired media format when downloading a message recording. Valid values:ZIP,NONE (optional)
     - parameter download: (query) requesting a download format of the recording. Valid values:true,false (optional)
     - parameter fileName: (query) the name of the downloaded fileName (optional)
     - parameter locale: (query) The locale for the requested file when downloading or for redacting sensitive information in requested files, as an ISO 639-1 code (optional)
  ...
  "deleteDate" : "2000-01-23T04:56:07.000+00:00"
    ...
    /**
     ...
     - parameter conversationId: (path) Conversation ID 
     - parameter maxWaitMs: (query) The maximum number of milliseconds to wait for the recording to be ready. Must be a positive value. (optional)
     - parameter formatId: (query) The desired media format. Valid values:WAV,WEBM,WAV_ULAW,OGG_VORBIS,OGG_OPUS,MP3,NONE. (optional)
     - parameter mediaFormats: (query) All acceptable media formats. Overrides formatId. Valid values:WAV,WEBM,WAV_ULAW,OGG_VORBIS,OGG_OPUS,MP3. (optional)
  ...
  "region" : "af-south-1"
    ...
    /**
     ...
     - parameter emailFormatId: (query) The desired media format when downloading an email recording. (optional)
     - parameter chatFormatId: (query) The desired media format when downloading a chat recording. (optional)
     - parameter messageFormatId: (query) The desired media format when downloading a message recording. (optional)
     - parameter download: (query) requesting a download format of the recording (optional)
     - parameter fileName: (query) the name of the downloaded fileName (optional)
  ...
  "mediaSubject" : "mediaSubject"
    ...
    /**
     ...
     - parameter hasConversation: (query) Filter resulting orphans by whether the conversation is known. False returns all orphans for the organization. (optional)
  ...
  "status" : "InProgress"
    ...
    /**
     ...
     - parameter summary: (query) provides a less verbose response of policy lists. (optional)
  ...
  "dateCreated" : "2000-01-23T04:56:07.000+00:00",
  "percentProgress" : 2,
  "totalSkippedRecordings" : 1,
  "totalFailedRecordings" : 5,
  "id" : "id",
  "state" : "FULFILLED",
  "user" : "{}",
  "recordingJobsQuery" : "{}",
  ...
  "nextUri" : "https://openapi-generator.tech"
    ...
    /**
     ...
     - OAuth:
       ...
       - name: PureCloud OAuth
     - examples: [{contentType=application/json, example={
  "keyConfigurationType" : "KmsSymmetric",
  "lastError" : "{}",
  "apiKey" : "apiKey",
  "selfUri" : "https://openapi-generator.tech",
  "id" : "id",
  ...
  "id" : "id"
    ...
    /**
     ...
     - parameter createDefault: (query) If no settings are found, a new one is created with default values (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "signedUrl" : "signedUrl"
    ...
    /**
     ...
     - parameter retentionThresholdDays: (query) Fetch retention data for recordings retained for more days than the provided value. 
     - parameter cursor: (query) Indicates where to resume query results (not required for first page) (optional)
     - parameter pageSize: (query) Page size. Maximum is 500. (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getRecordingsRetentionQuery(retentionThresholdDays: Int, cursor: String? = nil, pageSize: Int? = nil, completion: @escaping ((_ data: RecordingRetentionCursorEntityListing?,_ error: Error?) -> Void)) {
        let requestBuilder = getRecordingsRetentionQueryWithRequestBuilder(retentionThresholdDays: retentionThresholdDays, cursor: cursor, pageSize: pageSize)
        requestBuilder.execute { (response: Response<RecordingRetentionCursorEntityListing>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
                } else if let r = response {
  ...
  "previousUri" : "previousUri"
     ...
     - returns: RequestBuilder<RecordingRetentionCursorEntityListing> 
     */
    open class func getRecordingsRetentionQueryWithRequestBuilder(retentionThresholdDays: Int, cursor: String? = nil, pageSize: Int? = nil) -> RequestBuilder<RecordingRetentionCursorEntityListing> {        
        let path = "/api/v2/recordings/retention/query"
        let URLString = PureCloudPlatformClientV2API.basePath + path
        let body: Data? = nil
