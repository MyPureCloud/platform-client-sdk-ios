...
open class BackgroundAssistantAPI {
     ...
     */
    open class func postScreenrecordingToken(body: BackgroundAssistantUserAuthenticatedInfo? = nil, completion: @escaping ((_ data: SignedData?,_ error: Error?) -> Void)) {
  ...
  "jwt" : "jwt"
     ...
     */
    open class func postScreenrecordingTokenWithRequestBuilder(body: BackgroundAssistantUserAuthenticatedInfo? = nil) -> RequestBuilder<SignedData> {        
