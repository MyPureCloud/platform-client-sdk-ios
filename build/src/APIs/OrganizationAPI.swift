...
open class OrganizationAPI {
  ...
  "entities" : [ {
    ...
    /**
     ...
     - parameter namespaceName: (path) The namespace to get 
     - parameter cursor: (query) Cursor provided when retrieving the last page (optional)
     - parameter entityId: (query) entity id of the count (optional)
     - parameter userId: (query) userid of the count (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationsLimitsNamespaceCounts(namespaceName: String, cursor: String? = nil, entityId: String? = nil, userId: String? = nil, completion: @escaping ((_ data: LimitCountListing?,_ error: Error?) -> Void)) {
        let requestBuilder = getOrganizationsLimitsNamespaceCountsWithRequestBuilder(namespaceName: namespaceName, cursor: cursor, entityId: entityId, userId: userId)
        requestBuilder.execute { (response: Response<LimitCountListing>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
                } else if let r = response {
  ...
  "nextUri" : "nextUri"
     ...
     - returns: RequestBuilder<LimitCountListing> 
     */
    open class func getOrganizationsLimitsNamespaceCountsWithRequestBuilder(namespaceName: String, cursor: String? = nil, entityId: String? = nil, userId: String? = nil) -> RequestBuilder<LimitCountListing> {        
        var path = "/api/v2/organizations/limits/namespaces/{namespaceName}/counts"
        let namespaceNamePreEscape = "\(namespaceName)"
        let namespaceNamePostEscape = namespaceNamePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{namespaceName}", with: namespaceNamePostEscape, options: .literal, range: nil)
        let URLString = PureCloudPlatformClientV2API.basePath + path
        ...
        let requestBuilder: RequestBuilder<LimitCountListing>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
  ...
  "entities" : [ {
    ...
    /**
     ...
     - parameter namespaceName: (path) The namespace to get 
     - parameter limitName: (path) The limit to get 
     - parameter entityId: (query) entity id of the count (optional)
     - parameter userId: (query) userid of the count (optional)
     - parameter cursor: (query) Cursor provided when retrieving the last page (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationsLimitsNamespaceLimitCounts(namespaceName: String, limitName: String, entityId: String? = nil, userId: String? = nil, cursor: String? = nil, completion: @escaping ((_ data: LimitCountListing?,_ error: Error?) -> Void)) {
        let requestBuilder = getOrganizationsLimitsNamespaceLimitCountsWithRequestBuilder(namespaceName: namespaceName, limitName: limitName, entityId: entityId, userId: userId, cursor: cursor)
        requestBuilder.execute { (response: Response<LimitCountListing>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "nextUri" : "nextUri"
     ...
     - returns: RequestBuilder<LimitCountListing> 
     */
    open class func getOrganizationsLimitsNamespaceLimitCountsWithRequestBuilder(namespaceName: String, limitName: String, entityId: String? = nil, userId: String? = nil, cursor: String? = nil) -> RequestBuilder<LimitCountListing> {        
        var path = "/api/v2/organizations/limits/namespaces/{namespaceName}/limits/{limitName}/counts"
        let namespaceNamePreEscape = "\(namespaceName)"
        let namespaceNamePostEscape = namespaceNamePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{namespaceName}", with: namespaceNamePostEscape, options: .literal, range: nil)
        let limitNamePreEscape = "\(limitName)"
        let limitNamePostEscape = limitNamePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{limitName}", with: limitNamePostEscape, options: .literal, range: nil)
        let URLString = PureCloudPlatformClientV2API.basePath + path
        let body: Data? = nil
