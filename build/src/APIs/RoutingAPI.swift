...
open class RoutingAPI {
  ...
  "previousUri" : "previousUri"
    ...
    public enum Expand_getRoutingPredictorsKeyperformanceindicators: String { 
        case queues = "queues"
    }
  ...
  "piiRedactionEnabled" : true
    ...
    /**
     ...
     - parameter skillId: (path) Skill ID 
     - parameter body: (body) updateSkillDivisionRequest 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchRoutingSkill(skillId: String, body: UpdateSkillDivisionRequest, completion: @escaping ((_ data: RoutingSkill?,_ error: Error?) -> Void)) {
        let requestBuilder = patchRoutingSkillWithRequestBuilder(skillId: skillId, body: body)
        requestBuilder.execute { (response: Response<RoutingSkill>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "version" : "version"
     ...
     - returns: RequestBuilder<RoutingSkill> 
     */
    open class func patchRoutingSkillWithRequestBuilder(skillId: String, body: UpdateSkillDivisionRequest) -> RequestBuilder<RoutingSkill> {        
        var path = "/api/v2/routing/skills/{skillId}"
        let skillIdPreEscape = "\(skillId)"
        let skillIdPostEscape = skillIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{skillId}", with: skillIdPostEscape, options: .literal, range: nil)
  ...
  "status" : "InProgress"
    ...
    /**
     ...
     - parameter phoneNumberId: (path) phone number 
     - parameter body: (body) SmsPhoneNumberPatchRequest 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchRoutingSmsPhonenumber(phoneNumberId: String, body: SmsPhoneNumberPatchRequest, completion: @escaping ((_ data: SmsPhoneNumber?,_ error: Error?) -> Void)) {
        let requestBuilder = patchRoutingSmsPhonenumberWithRequestBuilder(phoneNumberId: phoneNumberId, body: body)
        requestBuilder.execute { (response: Response<SmsPhoneNumber>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "integration" : "{}"
     ...
     - returns: RequestBuilder<SmsPhoneNumber> 
     */
    open class func patchRoutingSmsPhonenumberWithRequestBuilder(phoneNumberId: String, body: SmsPhoneNumberPatchRequest) -> RequestBuilder<SmsPhoneNumber> {        
        var path = "/api/v2/routing/sms/phonenumbers/{phoneNumberId}"
        let phoneNumberIdPreEscape = "\(phoneNumberId)"
        let phoneNumberIdPostEscape = phoneNumberIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{phoneNumberId}", with: phoneNumberIdPostEscape, options: .literal, range: nil)
