...
|------------ | ------------- | ------------- | -------------|
| **violationMessages** | [**[WorkPlanConfigurationViolationMessage]**]([WorkPlanConfigurationViolationMessage]) | Messages for work plan violating some rules such as no shifts in a work plan | [optional] |
