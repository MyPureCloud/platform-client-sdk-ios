...
| **categoryId** | **String**| Category ID | |
| **knowledgeBaseId** | **String**| Knowledge base ID | |
| **languageCode** | **String**| Language code, format: iso2-LOCALE |<br />**Values**: enUs ("en-US"), enUk ("en-UK"), enAu ("en-AU"), enCa ("en-CA"), enHk ("en-HK"), enIn ("en-IN"), enIe ("en-IE"), enNz ("en-NZ"), enPh ("en-PH"), enSg ("en-SG"), enZa ("en-ZA"), deDe ("de-DE"), deAt ("de-AT"), deCh ("de-CH"), esAr ("es-AR"), esCo ("es-CO"), esMx ("es-MX"), esUs ("es-US"), esEs ("es-ES"), frFr ("fr-FR"), frBe ("fr-BE"), frCa ("fr-CA"), frCh ("fr-CH"), ptBr ("pt-BR"), ptPt ("pt-PT"), nlNl ("nl-NL"), nlBe ("nl-BE"), itIt ("it-IT"), caEs ("ca-ES"), trTr ("tr-TR"), svSe ("sv-SE"), fiFi ("fi-FI"), nbNo ("nb-NO"), daDk ("da-DK"), jaJp ("ja-JP"), arAe ("ar-AE"), zhCn ("zh-CN"), zhTw ("zh-TW"), zhHk ("zh-HK"), koKr ("ko-KR"), plPl ("pl-PL") |
{: class="table-striped"}
...
| **knowledgeBaseId** | **String**| Knowledge base ID. | |
| **documentId** | **String**| Document ID. | |
| **expand** | [**[String]**](String.html)| The specified entity attributes will be filled. Comma separated values expected. Max No. of variations that can be returned on expand is 20. | [optional]<br />**Values**: category ("category"), labels ("labels"), variations ("variations") |
...
| **expand** | [**[String]**](String.html)| The specified entity attributes will be filled. Comma separated values expected. | [optional]<br />**Values**: category ("category"), labels ("labels") |
{: class="table-striped"}
...
KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroup(knowledgeBaseId: knowledgeBaseId, groupId: groupId, app: app, dateStart: dateStart, dateEnd: dateEnd) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroup was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroupPhrasegroup(knowledgeBaseId: knowledgeBaseId, groupId: groupId, phraseGroupId: phraseGroupId, app: app, dateStart: dateStart, dateEnd: dateEnd) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroupPhrasegroup was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroups(knowledgeBaseId: knowledgeBaseId, app: app, dateStart: dateStart, dateEnd: dateEnd) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.getKnowledgeKnowledgebaseUnansweredGroups was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeGuestSessionDocumentsSearchSearchId(sessionId: sessionId, searchId: searchId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.patchKnowledgeGuestSessionDocumentsSearchSearchId was successful")
    }
}
```
...
KnowledgeAPI.patchKnowledgeKnowledgebaseCategory(knowledgeBaseId: knowledgeBaseId, categoryId: categoryId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseCategory was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeKnowledgebaseDocument(knowledgeBaseId: knowledgeBaseId, documentId: documentId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseDocument was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.patchKnowledgeKnowledgebaseDocumentVariation(documentVariationId: documentVariationId, documentId: documentId, knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseDocumentVariation was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeKnowledgebaseDocumentsSearchSearchId(knowledgeBaseId: knowledgeBaseId, searchId: searchId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseDocumentsSearchSearchId was successful")
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeKnowledgebaseImportJob(knowledgeBaseId: knowledgeBaseId, importJobId: importJobId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseImportJob was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeKnowledgebaseLabel(knowledgeBaseId: knowledgeBaseId, labelId: labelId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseLabel was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.patchKnowledgeKnowledgebaseUnansweredGroupPhrasegroup(knowledgeBaseId: knowledgeBaseId, groupId: groupId, phraseGroupId: phraseGroupId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.patchKnowledgeKnowledgebaseUnansweredGroupPhrasegroup was successful")
        dump(response)
    }
}
```
...
let sessionId: String = "" // Knowledge guest session ID.
let documentId: String = "" // Document ID
let body: KnowledgeGuestDocumentCopy = new KnowledgeGuestDocumentCopy(...) // 

// Code example
KnowledgeAPI.postKnowledgeGuestSessionDocumentCopies(sessionId: sessionId, documentId: documentId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.postKnowledgeGuestSessionDocumentCopies was successful")
    }
}
```
...
let sessionId: String = "" // Knowledge guest session ID.
let documentId: String = "" // Document ID
let body: KnowledgeGuestDocumentView = new KnowledgeGuestDocumentView(...) // 

// Code example
KnowledgeAPI.postKnowledgeGuestSessionDocumentViews(sessionId: sessionId, documentId: documentId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.postKnowledgeGuestSessionDocumentViews was successful")
    }
}
```
...
let sessionId: String = "" // Knowledge guest session ID.
let body: KnowledgeGuestDocumentPresentation = new KnowledgeGuestDocumentPresentation(...) // 

// Code example
KnowledgeAPI.postKnowledgeGuestSessionDocumentsPresentations(sessionId: sessionId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.postKnowledgeGuestSessionDocumentsPresentations was successful")
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeGuestSessionDocumentsSearch(sessionId: sessionId, expand: expand, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeGuestSessionDocumentsSearch was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.postKnowledgeGuestSessionDocumentsSearchSuggestions(sessionId: sessionId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.postKnowledgeGuestSessionDocumentsSearchSuggestions was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeGuestSessions(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeGuestSessions was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.postKnowledgeKnowledgebaseCategories(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.postKnowledgeKnowledgebaseCategories was successful")
        dump(response)
    }
}
```
...
let knowledgeBaseId: String = "" // Knowledge base ID.
let documentId: String = "" // Document ID.
let body: KnowledgeDocumentCopy = new KnowledgeDocumentCopy(...) // 

// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentCopies(knowledgeBaseId: knowledgeBaseId, documentId: documentId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentCopies was successful")
    }
}
```
...
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentVariations(knowledgeBaseId: knowledgeBaseId, documentId: documentId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentVariations was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentVersions(knowledgeBaseId: knowledgeBaseId, documentId: documentId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentVersions was successful")
        dump(response)
    }
}
```
...
KnowledgeAPI.postKnowledgeKnowledgebaseDocuments(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        ...
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocuments was successful")
        dump(response)
    }
}
```
...
let knowledgeBaseId: String = "" // Knowledge base ID.
let body: KnowledgeDocumentPresentation = new KnowledgeDocumentPresentation(...) // 

// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsPresentations(knowledgeBaseId: knowledgeBaseId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsPresentations was successful")
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsSearch(knowledgeBaseId: knowledgeBaseId, expand: expand, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsSearch was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsSearchSuggestions(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseDocumentsSearchSuggestions was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseExportJobs(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseExportJobs was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseImportJobs(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseImportJobs was successful")
        dump(response)
    }
}
```
...
// Code example
KnowledgeAPI.postKnowledgeKnowledgebaseLabels(knowledgeBaseId: knowledgeBaseId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("KnowledgeAPI.postKnowledgeKnowledgebaseLabels was successful")
        dump(response)
    }
}
```
