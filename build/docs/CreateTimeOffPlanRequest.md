...
| **activityCodeIds** | **[String]** | Deprecated. The set of activity code IDs to associate with this time off plan. | [optional] |
| **timeOffLimitIds** | **[String]** | Deprecated. The set of time off limit IDs to associate with this time off plan. | [optional] |
