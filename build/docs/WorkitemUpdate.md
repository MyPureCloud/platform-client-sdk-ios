...
| **customFields** | [**[String:JSON]**](JSON.html) | Custom fields defined in the schema referenced by the worktype of the workitem. If set to {}, the existing keys and values will be removed. | [optional] |
...
| **scoredAgents** | [**[WorkitemScoredAgentRequest]**](WorkitemScoredAgentRequest.html) | A list of scored agents for the Workitem. A workitem can have a maximum of 20 scored agents. | [optional] |
