...
// Code example
TelephonyProvidersEdgeAPI.deleteTelephonyProvidersEdgesAlertablepresences() { (error) in
    if let error = error {
        dump(error)
    } else {
        print("TelephonyProvidersEdgeAPI.deleteTelephonyProvidersEdgesAlertablepresences was successful")
    }
}
```
...
let type: TelephonyProvidersEdgeAPI.ModelType_getTelephonyProvidersEdgesAlertablepresences = TelephonyProvidersEdgeAPI.ModelType_getTelephonyProvidersEdgesAlertablepresences.enummember // 

// Code example
TelephonyProvidersEdgeAPI.getTelephonyProvidersEdgesAlertablepresences(type: type) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("TelephonyProvidersEdgeAPI.getTelephonyProvidersEdgesAlertablepresences was successful")
        dump(response)
    }
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **type** | **String**|  | [optional]<br />**Values**: defaults ("defaults"), overrides ("overrides") |
...
let siteId: String = "" // Site ID for trunk bases
let pageNumber: Int = 0 // Page number
let pageSize: Int = 0 // Page size
let sortBy: String = "" // Value by which to sort
let sortOrder: String = "" // Sort order
...
// Code example
TelephonyProvidersEdgeAPI.getTelephonyProvidersEdgesTrunkbasesettingsSiteSiteId(siteId: siteId, pageNumber: pageNumber, pageSize: pageSize, sortBy: sortBy, sortOrder: sortOrder) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("TelephonyProvidersEdgeAPI.getTelephonyProvidersEdgesTrunkbasesettingsSiteSiteId was successful")
        dump(response)
    }
}
```
...
let edgeId: String = "" // Edge Id
let body: EdgeOfflineConfiguration = new EdgeOfflineConfiguration(...) // EdgeOfflineConfiguration

// Code example
TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgeOfflineconfiguration(edgeId: edgeId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgeOfflineconfiguration was successful")
        dump(response)
    }
}
```
...
let body: TelephonySearchRequest = new TelephonySearchRequest(...) // Telephony search request

// Code example
TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgesTrunkbasesettingsSearch(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgesTrunkbasesettingsSearch was successful")
        dump(response)
    }
}
```
...
// Code example
TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgesTrunksSearch(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("TelephonyProvidersEdgeAPI.postTelephonyProvidersEdgesTrunksSearch was successful")
        dump(response)
    }
}
```
...
let body: AlertablePresences = new AlertablePresences(...) // Alertable Presences Overrides

// Code example
TelephonyProvidersEdgeAPI.putTelephonyProvidersEdgesAlertablepresences(body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("TelephonyProvidersEdgeAPI.putTelephonyProvidersEdgesAlertablepresences was successful")
    }
}
```
