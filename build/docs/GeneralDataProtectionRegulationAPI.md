...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **searchType** | **String**| Search Type |<br />**Values**: name ("NAME"), address ("ADDRESS"), phone ("PHONE"), email ("EMAIL"), twitter ("TWITTER"), instagram ("INSTAGRAM"), facebook ("FACEBOOK"), appleMessages ("APPLE_MESSAGES"), whatsapp ("WHATSAPP"), externalId ("EXTERNAL_ID") |
