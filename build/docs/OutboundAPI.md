...
// Code example
OutboundAPI.deleteOutboundDnclistCustomexclusioncolumns(dncListId: dncListId, expiredOnly: expiredOnly) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("OutboundAPI.deleteOutboundDnclistCustomexclusioncolumns was successful")
    }
}
```
...
let whatsAppCampaignId: String = "" // WhatsApp Campaign ID

// Code example
OutboundAPI.deleteOutboundSchedulesWhatsappcampaign(whatsAppCampaignId: whatsAppCampaignId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("OutboundAPI.deleteOutboundSchedulesWhatsappcampaign was successful")
    }
}
```
...
// Code example
OutboundAPI.getOutboundCampaignAgentownedmappingpreviewResults(campaignId: campaignId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("OutboundAPI.getOutboundCampaignAgentownedmappingpreviewResults was successful")
        dump(response)
    }
}
```
...
// Code example
OutboundAPI.getOutboundSchedulesWhatsappcampaign(whatsAppCampaignId: whatsAppCampaignId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("OutboundAPI.getOutboundSchedulesWhatsappcampaign was successful")
        dump(response)
    }
}
```
...
// Code example
OutboundAPI.getOutboundSchedulesWhatsappcampaigns() { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("OutboundAPI.getOutboundSchedulesWhatsappcampaigns was successful")
        dump(response)
    }
}
```
...
// Code example
OutboundAPI.patchOutboundDnclistCustomexclusioncolumns(dncListId: dncListId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("OutboundAPI.patchOutboundDnclistCustomexclusioncolumns was successful")
    }
}
```
...
// Code example
OutboundAPI.postOutboundCampaignAgentownedmappingpreview(campaignId: campaignId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("OutboundAPI.postOutboundCampaignAgentownedmappingpreview was successful")
        dump(response)
    }
}
```
...
// Code example
OutboundAPI.postOutboundDnclistEmailaddresses(dncListId: dncListId, body: body) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("OutboundAPI.postOutboundDnclistEmailaddresses was successful")
    }
}
```
...
let whatsAppCampaignId: String = "" // WhatsApp Campaign ID
let body: WhatsAppCampaignSchedule = new WhatsAppCampaignSchedule(...) // WhatsAppCampaignSchedule

// Code example
OutboundAPI.putOutboundSchedulesWhatsappcampaign(whatsAppCampaignId: whatsAppCampaignId, body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("OutboundAPI.putOutboundSchedulesWhatsappcampaign was successful")
        dump(response)
    }
}
```
