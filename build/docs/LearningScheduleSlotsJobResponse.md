...
| **userIds** | **[String]** | The user IDs to fetch the slots for. | [optional] |
...
| **results** | [**[LearningScheduleSlotsJobResult]**]([LearningScheduleSlotsJobResult]) | The results of the job. | [optional] |
