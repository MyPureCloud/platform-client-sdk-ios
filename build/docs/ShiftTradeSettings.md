...
| **externalActivityRules** | [**[ShiftTradeExternalActivityRule]**]([ShiftTradeExternalActivityRule]) | Rules that specify what to do with external activities that are part of a shift | [optional] |
