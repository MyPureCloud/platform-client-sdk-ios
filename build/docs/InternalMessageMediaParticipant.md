...
| **internalMessageId** | **String** | The internal message communication ID. | [optional] |
| **targetUser** | [**AddressableEntityRef**](AddressableEntityRef) | The user participant on receiving side of the internal message conversation. | [optional] |
| **sourceUser** | [**AddressableEntityRef**](AddressableEntityRef) | The user participant on sending side of the internal message conversation. | [optional] |
...
| **messages** | [**[InternalMessageDetails]**]([InternalMessageDetails]) | Message instance details on the communication. | [optional] |
