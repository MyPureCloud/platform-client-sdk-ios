...
| **planningGroupOverrides** | [**[PlanningGroupMinimumsResponse]**]([PlanningGroupMinimumsResponse]) | List of planning groups with their minimum staff value overrides and the days to which the overrides apply | |
