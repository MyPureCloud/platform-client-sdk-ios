...
Documentation version PureCloudPlatformClientV2@173.0.0
...
```
pod 'PureCloudPlatformClientV2', :git => 'https://github.com/MyPureCloud/platform-client-sdk-ios.git', :tag => '173.0.0'
```
