...
Documentation version PureCloudPlatformClientV2@198.0.0
...
```
pod 'PureCloudPlatformClientV2', :git => 'https://github.com/MyPureCloud/platform-client-sdk-ios.git', :tag => '198.0.0'
```
