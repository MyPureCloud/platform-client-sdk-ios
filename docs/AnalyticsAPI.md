...
| [**deleteAnalyticsEvaluationsAggregatesJob**](AnalyticsAPI#deleteAnalyticsEvaluationsAggregatesJob) | Delete/cancel an async request for evaluation aggregates |
| [**deleteAnalyticsFlowexecutionsAggregatesJob**](AnalyticsAPI#deleteAnalyticsFlowexecutionsAggregatesJob) | Delete/cancel an async request for flow execution aggregates |
| [**deleteAnalyticsFlowsAggregatesJob**](AnalyticsAPI#deleteAnalyticsFlowsAggregatesJob) | Delete/cancel an async request for flow aggregates |
| [**deleteAnalyticsJourneysAggregatesJob**](AnalyticsAPI#deleteAnalyticsJourneysAggregatesJob) | Delete/cancel an async request for journey aggregates |
| [**deleteAnalyticsKnowledgeAggregatesJob**](AnalyticsAPI#deleteAnalyticsKnowledgeAggregatesJob) | Delete/cancel an async request for knowledge aggregates |
| [**deleteAnalyticsResolutionsAggregatesJob**](AnalyticsAPI#deleteAnalyticsResolutionsAggregatesJob) | Delete/cancel an async request for resolution aggregates |
| [**deleteAnalyticsSummariesAggregatesJob**](AnalyticsAPI#deleteAnalyticsSummariesAggregatesJob) | Delete/cancel an async request for summary aggregates |
| [**deleteAnalyticsSurveysAggregatesJob**](AnalyticsAPI#deleteAnalyticsSurveysAggregatesJob) | Delete/cancel an async request for survey aggregates |
| [**deleteAnalyticsTaskmanagementAggregatesJob**](AnalyticsAPI#deleteAnalyticsTaskmanagementAggregatesJob) | Delete/cancel an async request for task management aggregates |
| [**deleteAnalyticsTranscriptsAggregatesJob**](AnalyticsAPI#deleteAnalyticsTranscriptsAggregatesJob) | Delete/cancel an async request for transcript aggregates |
| [**deleteAnalyticsUsersAggregatesJob**](AnalyticsAPI#deleteAnalyticsUsersAggregatesJob) | Delete/cancel an async request for user aggregates |
...
| [**getAnalyticsBotsAggregatesJob**](AnalyticsAPI#getAnalyticsBotsAggregatesJob) | Get status for async query for bot aggregates |
| [**getAnalyticsBotsAggregatesJobResults**](AnalyticsAPI#getAnalyticsBotsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsCasemanagementAggregatesJob**](AnalyticsAPI#getAnalyticsCasemanagementAggregatesJob) | Get status for async query for case management aggregates |
| [**getAnalyticsCasemanagementAggregatesJobResults**](AnalyticsAPI#getAnalyticsCasemanagementAggregatesJobResults) | Fetch a page of results for an async case management query |
| [**getAnalyticsConversationDetails**](AnalyticsAPI#getAnalyticsConversationDetails) | Get a conversation by id |
| [**getAnalyticsConversationsAggregatesJob**](AnalyticsAPI#getAnalyticsConversationsAggregatesJob) | Get status for async query for conversation aggregates |
| [**getAnalyticsConversationsAggregatesJobResults**](AnalyticsAPI#getAnalyticsConversationsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
...
| [**getAnalyticsFlowexecutionsAggregatesJob**](AnalyticsAPI#getAnalyticsFlowexecutionsAggregatesJob) | Get status for async query for flow execution aggregates |
| [**getAnalyticsFlowexecutionsAggregatesJobResults**](AnalyticsAPI#getAnalyticsFlowexecutionsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsFlowsAggregatesJob**](AnalyticsAPI#getAnalyticsFlowsAggregatesJob) | Get status for async query for Flow aggregates |
| [**getAnalyticsFlowsAggregatesJobResults**](AnalyticsAPI#getAnalyticsFlowsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsJourneysAggregatesJob**](AnalyticsAPI#getAnalyticsJourneysAggregatesJob) | Get status for async query for journey aggregates |
| [**getAnalyticsJourneysAggregatesJobResults**](AnalyticsAPI#getAnalyticsJourneysAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsKnowledgeAggregatesJob**](AnalyticsAPI#getAnalyticsKnowledgeAggregatesJob) | Get status for async query for knowledge aggregates |
| [**getAnalyticsKnowledgeAggregatesJobResults**](AnalyticsAPI#getAnalyticsKnowledgeAggregatesJobResults) | Fetch a page of results for an async aggregates query |
...
| [**getAnalyticsResolutionsAggregatesJob**](AnalyticsAPI#getAnalyticsResolutionsAggregatesJob) | Get status for async query for resolution aggregates |
| [**getAnalyticsResolutionsAggregatesJobResults**](AnalyticsAPI#getAnalyticsResolutionsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsSummariesAggregatesJob**](AnalyticsAPI#getAnalyticsSummariesAggregatesJob) | Get status for async query for summary aggregates |
| [**getAnalyticsSummariesAggregatesJobResults**](AnalyticsAPI#getAnalyticsSummariesAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsSurveysAggregatesJob**](AnalyticsAPI#getAnalyticsSurveysAggregatesJob) | Get status for async query for survey aggregates |
| [**getAnalyticsSurveysAggregatesJobResults**](AnalyticsAPI#getAnalyticsSurveysAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsTaskmanagementAggregatesJob**](AnalyticsAPI#getAnalyticsTaskmanagementAggregatesJob) | Get status for async query for task management aggregates |
| [**getAnalyticsTaskmanagementAggregatesJobResults**](AnalyticsAPI#getAnalyticsTaskmanagementAggregatesJobResults) | Fetch a page of results for an async task management query |
| [**getAnalyticsTranscriptsAggregatesJob**](AnalyticsAPI#getAnalyticsTranscriptsAggregatesJob) | Get status for async query for transcript aggregates |
| [**getAnalyticsTranscriptsAggregatesJobResults**](AnalyticsAPI#getAnalyticsTranscriptsAggregatesJobResults) | Fetch a page of results for an async aggregates query |
| [**getAnalyticsUsersAggregatesJob**](AnalyticsAPI#getAnalyticsUsersAggregatesJob) | Get status for async query for user aggregates |
| [**getAnalyticsUsersAggregatesJobResults**](AnalyticsAPI#getAnalyticsUsersAggregatesJobResults) | Fetch a page of results for an async aggregates query |
...
| [**postAnalyticsCasemanagementAggregatesQuery**](AnalyticsAPI#postAnalyticsCasemanagementAggregatesQuery) | Query for case management aggregates |
...
| [**postAnalyticsConversationsAggregatesJobs**](AnalyticsAPI#postAnalyticsConversationsAggregatesJobs) | Query for conversation aggregates asynchronously |
...
| [**postAnalyticsFlowsAggregatesJobs**](AnalyticsAPI#postAnalyticsFlowsAggregatesJobs) | Query for flow aggregates asynchronously |
...
| [**postAnalyticsJourneysAggregatesJobs**](AnalyticsAPI#postAnalyticsJourneysAggregatesJobs) | Query for journey aggregates asynchronously |
| [**postAnalyticsJourneysAggregatesQuery**](AnalyticsAPI#postAnalyticsJourneysAggregatesQuery) | Query for journey aggregates |
| [**postAnalyticsKnowledgeAggregatesJobs**](AnalyticsAPI#postAnalyticsKnowledgeAggregatesJobs) | Query for knowledge aggregates asynchronously |
...
| [**postAnalyticsSurveysAggregatesJobs**](AnalyticsAPI#postAnalyticsSurveysAggregatesJobs) | Query for survey aggregates asynchronously |
...
| [**postAnalyticsUsersAggregatesJobs**](AnalyticsAPI#postAnalyticsUsersAggregatesJobs) | Query for user aggregates asynchronously |
...
// Code example
AnalyticsAPI.deleteAnalyticsActionsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
...
// Code example
AnalyticsAPI.deleteAnalyticsBotsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsBotsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsCasemanagementAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsCasemanagementAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsConversationsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsConversationsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsEvaluationsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsEvaluationsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsFlowexecutionsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsFlowexecutionsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsFlowsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsFlowsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsJourneysAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsJourneysAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsKnowledgeAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsKnowledgeAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsResolutionsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsResolutionsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsSummariesAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsSummariesAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsSurveysAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsSurveysAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsTaskmanagementAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsTaskmanagementAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsTranscriptsAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsTranscriptsAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.deleteAnalyticsUsersAggregatesJob(jobId: jobId) { (error) in
    if let error = error {
        dump(error)
    } else {
        print("AnalyticsAPI.deleteAnalyticsUsersAggregatesJob was successful")
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsActionsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsActionsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsActionsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsActionsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsBotsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsBotsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsBotsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsBotsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
> [AsyncQueryStatus](AsyncQueryStatus) getAnalyticsCasemanagementAggregatesJob(jobId)
...
// Code example
AnalyticsAPI.getAnalyticsCasemanagementAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsCasemanagementAggregatesJob was successful")
        dump(response)
    }
}
```
...
> [CaseManagementAsyncAggregateQueryResponse](CaseManagementAsyncAggregateQueryResponse) getAnalyticsCasemanagementAggregatesJobResults(jobId, cursor)
...
// Code example
AnalyticsAPI.getAnalyticsCasemanagementAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsCasemanagementAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsConversationsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsConversationsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsConversationsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsConversationsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsEvaluationsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsEvaluationsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsEvaluationsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsEvaluationsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsFlowexecutionsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsFlowexecutionsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsFlowexecutionsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsFlowexecutionsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsFlowsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsFlowsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsFlowsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsFlowsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsJourneysAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsJourneysAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsJourneysAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsJourneysAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsKnowledgeAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsKnowledgeAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsKnowledgeAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsKnowledgeAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsResolutionsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsResolutionsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsResolutionsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsResolutionsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
> [AsyncQueryStatus](AsyncQueryStatus) getAnalyticsSummariesAggregatesJob(jobId)
...
// Code example
AnalyticsAPI.getAnalyticsSummariesAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsSummariesAggregatesJob was successful")
        dump(response)
    }
}
```
...
> [SummaryAsyncAggregateQueryResponse](SummaryAsyncAggregateQueryResponse) getAnalyticsSummariesAggregatesJobResults(jobId, cursor)
...
// Code example
AnalyticsAPI.getAnalyticsSummariesAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsSummariesAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsSurveysAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsSurveysAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsSurveysAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsSurveysAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsTaskmanagementAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsTaskmanagementAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsTaskmanagementAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsTaskmanagementAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsTranscriptsAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsTranscriptsAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsTranscriptsAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsTranscriptsAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsUsersAggregatesJob(jobId: jobId) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsUsersAggregatesJob was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.getAnalyticsUsersAggregatesJobResults(jobId: jobId, cursor: cursor) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.getAnalyticsUsersAggregatesJobResults was successful")
        dump(response)
    }
}
```
...
let body: ActionAsyncAggregationQuery = new ActionAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsActionsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsActionsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: BotAsyncAggregationQuery = new BotAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsBotsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsBotsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
> [AsyncQueryResponse](AsyncQueryResponse) postAnalyticsCasemanagementAggregatesJobs(body)
...
let body: CaseManagementAsyncAggregationQuery = new CaseManagementAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsCasemanagementAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsCasemanagementAggregatesJobs was successful")
        dump(response)
    }
}
```
...
> [CaseManagementAggregateQueryResponse](CaseManagementAggregateQueryResponse) postAnalyticsCasemanagementAggregatesQuery(body)
...
let body: CaseManagementAggregationQuery = new CaseManagementAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsCasemanagementAggregatesQuery(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsCasemanagementAggregatesQuery was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsConversationsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsConversationsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsEvaluationsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsEvaluationsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: FlowExecutionAsyncAggregationQuery = new FlowExecutionAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsFlowexecutionsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsFlowexecutionsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsFlowsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsFlowsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsJourneysAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsJourneysAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: KnowledgeAsyncAggregationQuery = new KnowledgeAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsKnowledgeAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsKnowledgeAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: ResolutionAsyncAggregationQuery = new ResolutionAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsResolutionsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsResolutionsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
> [AsyncQueryResponse](AsyncQueryResponse) postAnalyticsSummariesAggregatesJobs(body)
...
let body: SummaryAsyncAggregationQuery = new SummaryAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsSummariesAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsSummariesAggregatesJobs was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsSurveysAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsSurveysAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: TaskManagementAsyncAggregationQuery = new TaskManagementAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsTaskmanagementAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsTaskmanagementAggregatesJobs was successful")
        dump(response)
    }
}
```
...
let body: TranscriptAsyncAggregationQuery = new TranscriptAsyncAggregationQuery(...) // query

// Code example
AnalyticsAPI.postAnalyticsTranscriptsAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsTranscriptsAggregatesJobs was successful")
        dump(response)
    }
}
```
...
// Code example
AnalyticsAPI.postAnalyticsUsersAggregatesJobs(body: body) { (response, error) in
    if let error = error {
        dump(error)
    } else if let response = response {
        print("AnalyticsAPI.postAnalyticsUsersAggregatesJobs was successful")
        dump(response)
    }
}
```
