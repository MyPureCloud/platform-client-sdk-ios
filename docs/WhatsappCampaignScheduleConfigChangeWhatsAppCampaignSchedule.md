...
|------------ | ------------- | ------------- | -------------|
| **intervals** | [**[WhatsappCampaignScheduleConfigChangeScheduleInterval]**]([WhatsappCampaignScheduleConfigChangeScheduleInterval]) | a list of start and end times | [optional] |
| **recurrences** | [**[WhatsappCampaignScheduleConfigChangeScheduleRecurrence]**]([WhatsappCampaignScheduleConfigChangeScheduleRecurrence]) | a list of recurrences for a schedule | [optional] |
