...
| **userIds** | **[String]** | Specify if you only want a subset of userIds represented in the query. | [optional] |
| **oauthClientIds** | **[String]** | Specify if you only want a subset of oauthClientIds represented in the query. | [optional] |
