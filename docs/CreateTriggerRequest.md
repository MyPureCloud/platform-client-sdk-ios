...
| **matchCriteria** | [**[MatchCriteria]**](MatchCriteria) | The configuration for when a trigger is considered to be a match for an event. When not provided, all events will fire the trigger | [optional] |
