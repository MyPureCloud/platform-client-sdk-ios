...
| **alterations** | [**[EmailCampaignScheduleConfigChangeAlteration]**]([EmailCampaignScheduleConfigChangeAlteration]) | modifications to the original recurrence schedule | [optional] |
