...
Documentation version PureCloudPlatformClientV2@162.0.0
...
```
pod 'PureCloudPlatformClientV2', :git => 'https://github.com/MyPureCloud/platform-client-sdk-ios.git', :tag => '162.0.0'
```
