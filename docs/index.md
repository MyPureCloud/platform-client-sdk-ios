...
Documentation version PureCloudPlatformClientV2@160.0.0
...
```
pod 'PureCloudPlatformClientV2', :git => 'https://github.com/MyPureCloud/platform-client-sdk-ios.git', :tag => '160.0.0'
```
