...
|------------ | ------------- | ------------- | -------------|
| **_id** | **String** | ID of the social topic. | [optional] |
...
| **dataIngestionRulesMetadata** | [**[DataIngestionRulesMetadata]**]([DataIngestionRulesMetadata]) | The data ingestion rule metadata. | [optional] |
