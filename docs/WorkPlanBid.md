...
| **bidType** | **String** | The type of bid created | |
| **endOverridesAndRotations** | **Bool** | If true, all existing overrides, workplan rotations will be ended one day before effective date of this bid | |
